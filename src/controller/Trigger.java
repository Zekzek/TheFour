...
public abstract class Trigger {
	public static enum ID {
		...
		BEGINNINGS_DAMSEL_1, BEGINNINGS_SORCERESS_1, BEGINNINGS_BANDIT_ATTACK_1, BEGINNINGS_BANDIT_ATTACK_2, 
		BEGINNINGS_BANDIT_ATTACK_3, BEGINNINGS_GUARDS_ASSIST_1, BEGINNINGS_GUARDS_ASSIST_2, 
		BEGINNINGS_BANDIT_ESCAPE_1, BEGINNINGS_BANDIT_ESCAPE_2
	}
